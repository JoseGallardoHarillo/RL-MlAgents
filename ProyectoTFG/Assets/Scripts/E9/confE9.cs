...
//-----------------------------------------------------------------------------------------
        ...
        //Dirección a key.
        //Vector 3 posiciones. 
        sensor.AddObservation((Key.transform.position - transform.position).normalized);
//-----------------------------------------------------------------------------------------
        ...
        //Dirección a door.
        //Vector 3 posiciones. 
        sensor.AddObservation((Door.transform.position - transform.position).normalized);
